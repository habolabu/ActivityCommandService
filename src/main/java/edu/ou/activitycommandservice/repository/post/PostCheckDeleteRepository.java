...
public class PostCheckDeleteRepository extends BaseRepository<String, Boolean> {
    ...
    protected Boolean doExecute(String postSlug) {
        final String hqlQuery = "FROM PostEntity P " +
                "WHERE P.slug = :postSlug AND P.isDeleted IS NOT NULL";
