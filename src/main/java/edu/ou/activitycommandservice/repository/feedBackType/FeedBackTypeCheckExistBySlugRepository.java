...
public class FeedBackTypeCheckExistBySlugRepository extends BaseRepository<String, Boolean> {
    ...
    protected Boolean doExecute(String feedBackTypeSlug) {
        final String hqlQuery = "FROM FeedBackTypeEntity FBT WHERE FBT.slug = :feedBackTypeSlug AND FBT.isDeleted IS NULL";
